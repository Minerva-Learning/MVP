...
using Lean.Authentication;
using Lean.DashboardCustomization;
...
namespace Lean.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!LeanConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        LeanConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    ...
                    LeanDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(
                    AppSettings.DashboardCustomization.Configuration + "." +
                    LeanDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = LeanDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = LeanDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = LeanDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                {
                                    WidgetId =
                                        LeanDashboardCustomizationConsts.Widgets.Tenant
                ...
                new Dashboard
                {
                    DashboardName = LeanDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = LeanDashboardCustomizationConsts.Widgets.Host
                                        .TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                ...
                                {
                                    WidgetId =
                                        LeanDashboardCustomizationConsts.Widgets.Host
