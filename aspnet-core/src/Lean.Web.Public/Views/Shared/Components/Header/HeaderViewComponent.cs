...
using Lean.Url;
using Lean.Web.Public.Startup;
using Lean.Web.Session;

namespace Lean.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : LeanViewComponent
    {
