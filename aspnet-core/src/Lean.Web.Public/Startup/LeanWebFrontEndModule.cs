...
namespace Lean.Web.Public.Startup
{
    ...
    public class LeanWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public LeanWebFrontEndModule(IWebHostEnvironment env, LeanEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LeanWebFrontEndModule).GetAssembly());
        }
    }
}
