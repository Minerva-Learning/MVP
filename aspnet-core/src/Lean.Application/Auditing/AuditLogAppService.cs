...
using Lean.Auditing.Dto;
using Lean.Auditing.Exporting;
using Lean.Authorization;
using Lean.Authorization.Users;
using Lean.Dto;
using Lean.EntityHistory;
using EntityHistoryHelper = Lean.EntityHistory.EntityHistoryHelper;

namespace Lean.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : LeanAppServiceBase, IAuditLogAppService
    {
