...
using Lean.UiCustomization;
using Lean.Authorization.Delegation;
using Lean.Authorization.Users;

namespace Lean.Sessions
{
    public class SessionAppService : LeanAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = LeanConsts.Currency,
                    CurrencySign = LeanConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = LeanConsts.AllowTenantsToChangeEmailSettings,
