...
using Lean.DynamicEntityProperties.Dto;
using Lean.DynamicEntityPropertyValues.Dto;

namespace Lean.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : LeanAppServiceBase, IDynamicEntityPropertyValueAppService
    {
