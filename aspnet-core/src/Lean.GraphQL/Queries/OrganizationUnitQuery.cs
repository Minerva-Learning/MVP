...
using Lean.Core.Base;
using Lean.Core.Extensions;
using Lean.Dto;
using Lean.Types;

namespace Lean.Queries
{
    public class OrganizationUnitQuery : LeanQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
