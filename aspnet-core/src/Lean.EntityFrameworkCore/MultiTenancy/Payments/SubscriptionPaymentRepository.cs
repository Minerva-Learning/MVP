...
using Lean.EntityFrameworkCore.Repositories;

namespace Lean.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : LeanRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<LeanDbContext> dbContextProvider)
