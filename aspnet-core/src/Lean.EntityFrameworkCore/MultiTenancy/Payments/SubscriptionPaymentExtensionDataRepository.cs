...
{
    public class SubscriptionPaymentExtensionDataRepository : LeanRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<LeanDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
