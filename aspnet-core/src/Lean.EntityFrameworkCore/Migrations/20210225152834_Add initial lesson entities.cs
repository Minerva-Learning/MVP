...
{
    public partial class Addinitiallessonentities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonVideoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ActivityText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ActivityVideoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProblemAnswerOption", x => x.Id);
                    table.ForeignKey(
