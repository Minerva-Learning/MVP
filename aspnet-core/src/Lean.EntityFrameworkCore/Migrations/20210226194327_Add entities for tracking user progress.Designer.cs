...
namespace Lean.Migrations
{
    ...
    [Migration("20210226194327_Add entities for tracking user progress")]
    partial class Addentitiesfortrackinguserprogress
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lean.UserLessonsProgress.UserProblemResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lean.Lessons.Problem", b =>
                {
                    b.HasOne("Lean.Lessons.ProblemSet", "ProblemSetFk")
                        .WithMany("Problems")
                        .HasForeignKey("ProblemSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProblemSetFk");
                });
            ...
            modelBuilder.Entity("Lean.UserLessonsProgress.UserProblemAnswerOptionResult", b =>
                {
                    ...
                    b.HasOne("Lean.UserLessonsProgress.UserProblemResult", "UserProblemResultFk")
                        .WithMany()
