...
using Lean.Authentication.TwoFactor.Google;
using Lean.Authorization;
using Lean.Authorization.Accounts.Dto;
using Lean.Authorization.Users;
using Lean.MultiTenancy;
using Lean.Web.Authentication.JwtBearer;
using Lean.Web.Authentication.TwoFactor;
using Lean.Web.Models.TokenAuth;
...
using Lean.Web.Authentication.External;
...
namespace Lean.Web.Controllers
{
    ...
    public class TokenAuthController : LeanControllerBase
    {
