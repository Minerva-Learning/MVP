...
using Lean.Web.Configuration;
using Lean.Web.DashboardCustomization;

namespace Lean.Web
{
    [DependsOn(
        typeof(LeanApplicationModule),
        typeof(LeanEntityFrameworkCoreModule),
    ...
    public class LeanWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LeanWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(LeanApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LeanWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(LeanWebCoreModule).Assembly);
        }
