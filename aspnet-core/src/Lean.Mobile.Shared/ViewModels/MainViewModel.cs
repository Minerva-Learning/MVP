...
using Lean.Commands;
using Lean.Core.Threading;
using Lean.Models.NavigationMenu;
using Lean.Services.Navigation;
...
using Lean.ApiClient;
using Lean.Controls;
using Lean.Dto;
using Lean.Extensions;
using Lean.Localization;
using Lean.UI;
using Lean.UI.Assets;
using Lean.Views;
using DependencyResolver = Lean.Core.Dependency.DependencyResolver;
...
namespace Lean.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Lean";
