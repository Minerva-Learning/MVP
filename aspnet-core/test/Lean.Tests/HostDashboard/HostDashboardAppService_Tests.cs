...
using Lean.MultiTenancy.HostDashboard;
...
namespace Lean.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(LeanDbContext context, SubscriptionPayment subscriptionPayment)
        {
